...
namespace Tamarind.Cache
{
    ...
    public interface IStatsCounter
    {
        ...
        /// threads blocking on the load. Multiple concurrent calls to <see cref="ICache"/> lookup methods with
        /// the same key on an absent value should result in a single call to either
        /// <see cref="RecordLoadSuccess"/> or <see cref="RecordLoadExcetion"/> and multiple calls to this method,
        ...
        /// <see cref="RecordMisses"/>, this method should only be called by the loading thread.
        /// </summary>
        /// <param name="loadTime">The number of nanoseconds spent computing or retrieving the new value, prior to the exception being thrown.</param>
        ...
        /// <see cref="ICache.Invalidate"/> invalidations.
        /// </summary>
        void RecordEviction();
